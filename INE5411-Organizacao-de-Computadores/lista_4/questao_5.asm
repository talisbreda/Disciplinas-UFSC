...
main:	
	...
	jal	fatorial	# Chama de fun��o
	move	$s1, $v0	# Armazena o resultado
	
	# =====================================================================================
	# Inicia impress�o do resultado
	# =====================================================================================
	...
	# =====================================================================================
	# Finaliza impress�o do resultado
	# =====================================================================================
...
fatorial:
	...
	lw	$t0, 4($sp)	# Obt�m o valor anterior da stack
	mul	$v0, $v0, $t0	# Multiplica��o n * fatorial(n-1)
