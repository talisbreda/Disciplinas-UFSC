...
public class GrafoDirigido {
    ...
    public boolean haAresta(int v1, int v2) {
        return this.vertices.get(v1).arestas.get(this.vertices.get(v2)) != null;
    }
    ...
    public Double peso(int v1, int v2) {
        ...
        return this.vertices.get(v1).arestas.get(this.vertices.get(v2));
    }
    ...
    public void atualizaPeso(Vertice v1, Vertice v2, double peso) {
        v1.arestas.put(v2, peso);
        this.arestas.add(new Aresta(v1, v2, peso));
    }
